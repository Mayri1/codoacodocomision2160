      ...
      <div class="row ">
         <nav class="navbar navbar-expand-lg" id="menu" >
            <div class="container-fluid">
              <div class="izquierda">
                <a id="bsas" class="navbar-brand" href="#"><img src="./img/codoacodo.png" alt=""></a>
...
<div class="container-fluid d-flex justify-content-center" style="max-width: 1000px; margin-left: 200px;">
    <div class="row">
         <div class="d-flex" style="max-width: 900px;">
           ...
           <div class="col-12 m-2" style="max-width: 915px;" >
        ...
        <div class="form-row">
           ...
           <div id="totalPagar" class="alert alert-primary col-12 m-2 " role="alert" style="max-width: 895px;">Total a Pagar: $</div>
